...
class QueryMaker:
    ...
    def _convert_date_format(self, date_string: str):
    ...
    def _query_index(self, query_string: str, top_n: int = 5, metadata_filters: Dict = {}) -> Dict:
        ...
        if "date_published" in metadata_filters.keys():
            metadata_filters["date_published"].update((k, self._convert_date_format(v)) for k,v in metadata_filters["date_published"].items())
